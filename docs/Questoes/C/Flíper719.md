...
**Saída**
 ...
 A saída do seu programa deve ser também apenas uma linha, contendo uma letra maiúscula que indica o caminho por onde a bolinha vai cair: ‘A’, ‘B’ ou ‘C’. Restrições • O número P pode ser 0 ou 1. O número R pode ser 0 ou 1. Exemplos 
