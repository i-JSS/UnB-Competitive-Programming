...
int main() {
    while (1) {
        ...
        for(int i = 0; i < tam; i++) scanf("%d", &ordem[i]);
        ...
        while (i < tam) {
            ...
            else if(topo > 0 && pilha[topo - 1] == expected) {
                expected++;
                topo--;
            }
            else{
