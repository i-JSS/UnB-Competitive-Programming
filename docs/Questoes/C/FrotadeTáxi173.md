...
**Saída**
 ...
 A saída deve ser composta por uma única linha contendo o caractere ‘A’ se é mais econômico abastecer a frota com álcool ou o caractere ‘G’ se é mais econômico ou indiferente abastecer a frota com gasolina. Exemplo 1 
...
: G Restrições 0.01 <= A <= 10.00 0.01 <= G <= 10.00 0.01 <= Ra <= 20.00 
