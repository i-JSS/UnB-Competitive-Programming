...
**Saída**
 ...
 Seu programa deve imprimir uma única linha, contendo a palavra dentro se a bola bateu dentro da semi-quadra, e a palavra fora caso contrário. Restrições -500 ≤ X, Y ≤ 500 Exemplos 
