...
1. Primeiramente o seu processo deve ser capaz de tratar sinais SIGUSR1ou SIGUSR2
1. Depois de instalar os tratadores de sinais o seu processo deve aguardar algum dos sinais acima;
1. Assim que receber o sinal, o seu processo deve criar um processo **ZUMBI** e aguardar por outro sinal (qualquer um dos dois do passo 1)
1. Depois que seu processo receber mais um sinal, ele deverá ser capaz de eliminar o zumbi e deverá novamente esperar por outro sinal (qualquer um do passo 1)
1. Depois que seu processo receber esse último sinal ele deverá sair com *exit status* 0.
