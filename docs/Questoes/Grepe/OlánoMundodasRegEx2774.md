...
Você está iniciando no mundo da correção automática com exercícios de expressões regulares. Este é um momento bastante

delicado e por isso você deve prestar atenção em todos os detalhes de um problema.
...
Sua missão neste exercício é imprimir todas as ocorrências da string

 

Olá Mundo!

, independentemente de cada letra ser

capitalizada, ter ou não o marcador "!", ou conter acentos.
...
encontradas de cada caso de teste.
...
Bruno Ribeiro disse Olá Mundo

Bruno Ribas o respondeu com ola mundo
