...
Sua missão neste exercício é imprimir todas as linhas com ocorrências de pelo menos um número par.
...
) linha encontradas em que hajam pelo menos uma ocorrência de número par.
